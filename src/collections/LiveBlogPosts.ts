  ...
  fields: [
    {
      ...
      options: [
        ...
        { label: "Front-nine turn report", value: "turn-report" },
        { label: "Course record pace", value: "course-record-pace" },
        { label: "Course record broken/equalled", value: "course-record" },
        { label: "Record lead (championship history)", value: "record-lead" },
        { label: "Record winning margin (championship history)", value: "record-margin" },
        { label: "Record low winning score (championship history)", value: "record-low-score" },
